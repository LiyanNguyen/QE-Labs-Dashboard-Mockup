...
//chartJS configuration for drawing chart1
const chart1Config = {
	type: "bar",
	data: chart1Data,
	options: {
...
//chartJS configuration for drawing chart2
const chart2Config = {
	type: "pie",
	data: chart2Data,
	options: {
...
//chartJS configuration for drawing chart3
const chart3Config = {
	type: "line",
	data: chart3Data,
	options: {
